...
use App\Repository\PasswordVerificationCodeRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: PasswordVerificationCodeRepository::class)]
class PasswordVerificationCode
{
    ...
    #[ORM\ManyToOne(inversedBy: 'passwordVerificationCodes')]
